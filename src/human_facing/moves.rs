...
/// let opera_game = BoardContinuation::new(PSBoard::from_fen("1n2kb1r/p4ppp/4q3/4p1B1/4P3/8/PPP2PPP/2KR4 w k - 0 17").ok().unwrap());
/// let opera_result = make_an_uci_move(opera_game, "d1d8").ok().unwrap();
